...
if netspeed_active_interface ~= false then
    ...
    if interface_detail.AirPort then
        ...
        table.insert(
            menuitems_table,
            {title = "SSID: " .. ssid, tooltip = "Copy SSID to clipboard", fn = function()
    ...
    if interface_detail.IPv4 then
        ...
        table.insert(
            menuitems_table,
            {title = "IPv4: " .. ipv4, tooltip = "Copy IPv4 to clipboard", fn = function()
    ...
    if interface_detail.IPv6 then
        ...
        table.insert(
            menuitems_table,
            {title = "IPv6: " .. ipv6, tooltip = "Copy IPv6 to clipboard", fn = function()
    ...
    table.insert(
        menuitems_table,
        {title = "MAC Addr: " .. macaddr, tooltip = "Copy MAC Address to clipboard", fn = function()
